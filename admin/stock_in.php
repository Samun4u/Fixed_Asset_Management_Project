  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <ol class="breadcrumb">
      ...
      <li><a href="stock_in.php">Add Stock In </a></li>
    </ol>
  </section>
  <!-- Main content -->
          ...
          <div class="col-xs-12 col-md-12">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="text" onkeyup="calculate()" name="quantity" id="quantity" class="form-control" value="">
              </div>
              <div class="form-group">
                <label>Sub-Total</label>
                <input type="text" readonly name="sub_total" id="st" class="form-control" value="" required>
              </div>
            ...
            <div class="col-md-6">
             ...
             <div class="form-group">
              ...
              <input type="text" onkeyup="calculate()" id="d" name="discount" class="form-control" value="0">
            </div>
            <div class="form-group">
              <label>Total</label>
